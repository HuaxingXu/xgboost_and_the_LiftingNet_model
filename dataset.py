...
def data_expension(dataset, label, exnumber=50):
    ...
    print(expansion_dataset.shape)
    print(expansion_label.shape)
...
def expansion_and_add_noise(dataset, label, exnumber=50, noise_scales=0.01, is_label_sort=1, whether_link_original_data=1):
    if is_label_sort == 1:
        expansion_data, expansion_label = data_expension(dataset,label,exnumber)
    else:
        expansion_data, expansion_label = data_expension2(dataset,label,exnumber)
    if noise_scales!=0:
